  ...
  return (
    <section id="home" className="animated-gradient h-[70vh] pt-16 flex items-center justify-center relative overflow-hidden">
      ...
      <div class="text-center">
        ...
        <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Distribuímos e representamos as melhores soluções do mercado de educação básica brasileira, com milhares de usuários e resultados comprovados.</p>
