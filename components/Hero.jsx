    ...
    <section id="home" className="animated-gradient h-[70vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div class="hidden sm:mb-8 sm:flex sm:justify-center">
        <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
          Anunciamos nosso novo programa de compliance. <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Acesse aqui <span aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
